...
class Index extends React.Component{
  ...
  //显示/隐藏导航页面
  toggleNav(){
    let tab = this.refs['tabContainer']
    let tabWidth  = tab.offsetWidth

    let NB = this.refs['navBtn']
    ...
    return(
      <div className='page'>
        <div className='area'>
          ...
          <svg t="1597590349184" onClick={this.toggleNav.bind(this)} ref='navBtn' className="navBtn" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="7495" width="32" height="32"><path d="M38.5536 858.8288v-66.0992h946.944v66.0992H38.5536z m0-330.2912V462.4384H856.064v66.0992H38.5536z m0-330.3424v-66.048h946.944v66.0992H38.5536z" p-id="7496" fill="#ffffff"></path></svg>

          <div className='tabContainer' ref='tabContainer'>

                <div className='tabHeader'>
                          <svg t="1597590405426" onClick={this.toggleNav.bind(this)} ref='cancelBtn' className="cancelBtn" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="8317" width="32" height="32"><path d="M587.763033 510.545882L938.508395 159.800519c21.523199-21.523199 21.523199-56.419987 0-77.943186-21.523199-21.523199-56.419987-21.523199-77.943186 0L509.818823 432.602695 159.07346 81.857333c-21.523199-21.523199-56.419987-21.523199-77.943186 0-21.523199 21.523199-21.523199 56.419987 0 77.943186l350.745362 350.745363L81.130274 861.291245c-21.523199 21.523199-21.523199 56.419987 0 77.943186s56.419987 21.523199 77.943186 0l350.745363-350.745363L860.565209 939.234431c21.523199 21.523199 56.419987 21.523199 77.943186 0s21.523199-56.419987 0-77.943186L587.763033 510.545882z" p-id="8318" fill="#ffffff"></path></svg>
                          <p>My Components</p>
                </div>
